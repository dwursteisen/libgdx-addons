...
class LibGDXPlugin : Plugin<Project> {
    ...
    private fun bootstrapProjects(project: Project) {
        ...
        logger.debug("Creating default folder structure.")
        project.mkdir("core/src/main/kotlin")
        project.mkdir("core/assets/")
        project.mkdir("desktop/src/main/kotlin")
        logger.debug("Created default folder structure.")

        logger.debug("Updating settings gradle file.")
        val settings = """
        ...
        logger.debug("Updated settings gradle file.")
    }
}
